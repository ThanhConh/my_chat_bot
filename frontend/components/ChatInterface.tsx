        ...
        <div className="flex flex-col h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
            <div className="bg-white shadow-md">
                <div className="max-w-4xl mx-auto px-4 py-4">
                    <h1 className="text-2xl font-bold text-gray-800 flex items-center gap-2"><Bot className="w-8 h-8 text-indigo-600" /> LTC Architecture Chatbot</h1>
                ...
                <div className="max-w-4xl mx-auto px-4 py-6">
                    {messages.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500"> Hỏi tôi về dự án, kiến trúc, nội thất, hoặc tin tức của LTC</p>
                        </div>
                    ) : (
