# LTC Chatbot - RAG-based AI Assistant

Chatbot thông minh sử dụng Retrieval-Augmented Generation (RAG) để trả lời câu hỏi về công ty LTC Architects, dự án kiến trúc, nội thất và tin tức.
...
QDRANT_COLLECTION_NAME=ltc_chatbot_collection
QDRANT_TIMEOUT=30
...
Pipeline sẽ:
- Load data từ `data/raw/`
- Chunk documents theo loại
- Generate embeddings
- Upsert vào Qdrant
...
```bash
python -m api.main
# Nhập câu hỏi: "công ty LTC làm gì?"
```
...
curl http://localhost:6333/collections/ltc_chatbot_collection
